...
.PHONY: initrd
initrd: $(KERNEL_SYM)
	tar -cf initrd/initrd.tar initrd/etc/splash.txt initrd/fonts/ttyfont.psf initrd/bin/verdict initrd/bin/meminfo initrd/bin/specseek initrd/etc/kernel.sym
